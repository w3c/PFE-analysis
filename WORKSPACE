...
http_archive(
    ...
    sha256 = "88d3723519593385254d53afbd8a998299521f712c4189bdc7a576ed4ae1db26",
    strip_prefix = "harfbuzz-2.6.6",
    urls = ["https://github.com/harfbuzz/harfbuzz/archive/2.6.6.zip"],
)
